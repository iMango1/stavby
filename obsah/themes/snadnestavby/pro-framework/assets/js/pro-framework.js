...
;(function ( $, window, document, undefined ) {
  ...
  $.fn.PROWP_megamenu = function () {
	...
	// ======================================================
  // PROWP ONE-CLICK INSTALL
  // ======================================================
  $.fn.PROWP_oneClickInstall = function() {
    return this.each( function(){

      var _this           = $(this),
          _install        = _this.find('#pro-install'),
          _visit          = _this.find('#pro-visit-site'),
          _attachment     = _this.find('#pro-install-attachment'),
          _few_minutes    = _this.find('#pro-few-minutes'),
      ...
      _install.click( function ( e ){
        ...
        if ( !_installed && window.confirm( 'Are you sure?' ) ) {
          ...
          $.ajax({
            type  : 'POST',
            url   : ajaxurl,
            data  : { action: 'pro-import-dump', attachment: _is_attachment },
...
// ======================================================
	...
	$(document).ready( function(){
		...
		$('.pro-icon-select').PROWP_icon();
		$('#pro-one-click').PROWP_oneClickInstall();
		//$.reloadPlugins
