		...
		if ( isset( $field['type'] ) ) {
			switch ( $field['type'] ) {
				case "text":
					...
					$output .= '<label for="' . $field['id'] . '">' . esc_html__($field['title'], 'webuild' ) . '</label>';
					$output .= '<input class="widefat ' . $field['class'] . '" id="' . $field['id'] . '" name="' . $field['name'] . '" type="text" value="' . $value . '" />';
					$output .= '</p>';
					break;
				case "select":
					$output .= '<p class="' . $field['class'] . '">';
					$output .= '<label for="' . $field['id'] . '">' . esc_html__($field['title'], 'webuild' );
					...
					foreach ( $field['options'] as $key_option => $value_option ) {
						...
						$output .= '<option value="' . $key_option . '" ' . $selected . '>' . esc_html__( '' . $value_option, 'webuild' ) . '</option>';
					}
					$output .= '</select></label>';
					$output .= '</p>';
					break;
