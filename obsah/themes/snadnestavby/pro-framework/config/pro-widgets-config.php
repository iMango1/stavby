			...
			<div class="tab-hold tabs-wrapper">
				<ul id="tabs" class="tabset tabs">
					<?php if ( $show_popular_posts == 'true' ): ?>
						<li><a href="#tab-popular"><?php echo esc_html__( 'Popular', 'webuild' ); ?></a></li>
					<?php endif; ?>


					<?php if ( $show_recent_posts == 'true' ): ?>
						<li><a href="#tab-recent"><?php echo esc_html__( 'Recent', 'webuild' ); ?></a></li>
					<?php endif; ?>
									...
									<li>
										<div class="image">
											<a class="author">
												...
												<p><?php echo strip_tags( $comment->comment_author ); ?> <?php esc_html_e( 'says', 'webuild' ); ?>
													:</p>
											</a>
										</div>
										<div class="post-holder">
...
class PRO_DownloadsBtns_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		echo '<a class="brochure-box brochure-box-' . $uniqid . '" href="" target="_blank">';
