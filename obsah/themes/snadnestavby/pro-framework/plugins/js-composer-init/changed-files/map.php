...
$vc_map_style = array(
	'type'       => 'vc_webuild_style_textarea',
...
vc_map( array(
	...
	'params'        => array(
		array(
			...
			'param_name' => 'content',
			'value'      => wp_kses(__( '<p>I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>', 'js_composer' ),$allowed_html)
		),
		$add_css_animation,
		array(
			'type'        => 'textfield',
...
vc_map( array(
	...
	'as_parent'               => array( 'only' => 'webuild_button' ),
...
vc_map( array(
    ...
    [webuild_cta_block title="CTA Block Primary" tab_id="' . $cta_unique_id_1 . '"][/webuild_cta_block]


    [webuild_cta_block title="CTA Block Secondary" tab_id="' . $cta_unique_id_2 . '"][/webuild_cta_block]',
	'js_view'         => 'VcTabsView'
) );
// ==========================================================================================
// PRO CTA BLOCK
...
vc_map( array(
    ...
    [webuild_faq_block title="FAQ 1" tab_id="' . $faq_unique_id_1 . '"][vc_toggle title="Question"]Answer[/vc_toggle][/webuild_faq_block]


    [webuild_faq_block title="FAQ 2" tab_id="' . $faq_unique_id_2 . '"][vc_toggle title="Question"]Answer[/vc_toggle][/webuild_faq_block]


    [webuild_faq_block title="FAQ 3" tab_id="' . $faq_unique_id_3 . '"][vc_toggle title="Question"]Answer[/vc_toggle][/webuild_faq_block]',
	'js_view'                 => 'PROFAQSView'
) );
// ==========================================================================================
// PRO FAQ BLOCK
...
//     $vc_map_extra_style,
//   ),
//   'as_parent'               => array('only' => 'webuild_client'),
//   'js_view'                 => 'VcColumnView',
// ) );
// vc_map( array(
//   'name'            => 'Client',
...
//   'as_child'        => array('only' => 'webuild_clients'),
//   'params'          => array(
//     array(
//       'type'        => 'vc_webuild_upload',
//       'heading'     => 'Image',
//       'param_name'  => 'image',
//     ),
//     array(
...
vc_map( array(
    ...
    array(
      ...
      'group'       => 'Extras',
		...
		array(
			'type'       => 'vc_webuild_shortcode_textarea',
...
vc_map( array(
	...
	'base'        => 'webuild_responsive_slider',
...
// vc_map( array(
//   'name'                    => 'Testimonial',
//   'base'                    => 'webuild_testimonials',
//   'icon'                    => 'fa fa-comments',
//   'description'             => 'Create a testimonial slider',
//   'params'                  => $vc_map_defaults,
//   'as_parent'               => array('only' => 'webuild_testimonial'),
//   'content_element'         => true,
//   'show_settings_on_create' => false,
//   'js_view'                 => 'VcColumnView',
// ) );
...
// vc_map( array(
//   'name'            => 'BlockQuote',
//   'base'            => 'webuild_testimonial',
//   'icon'            => 'fa fa-comment',
//   'description'     => 'Create a blockquote',
//   'content_element' => true,
//   'as_child'        => array('only' => 'webuild_testimonials'),
//   'params'          => array(
//     array(
//       'type'        => 'textarea_html',
//       'holder'      => 'div',
...
// END RedBee testimonials <--
// START RedBee clients 
vc_map( array(
	'name'        => 'Clients',
	'base'        => 'vc_clients',
...
vc_map( array(
  ...
  'base'            => 'webuild_word_rotator',


  'icon'            => 'fa fa-info-circle',


  'description'     => 'Create a word rotator',
  ...
  'params'          => array(
	...
	array(
      ...
      'description' => 'Paste each word on separate line',
    ...
    array(
      ...
      'description' => 'Set the delay for the words in ms',
...
/*vc_map( array(
    ...
    'name' => esc_html__( 'Twitter Widget', 'js_composer' ),
  ...
  array(
        ...
        'heading' => esc_html__( 'Twitter username', 'js_composer' ),
        ...
        'description' => esc_html__( 'Type in twitter profile name from which load tweets.', 'js_composer' )
  ...
  array(
        ...
        'heading' => esc_html__( 'Tweets count', 'js_composer' ),
        ...
        'description' => esc_html__( 'How many recent tweets to load.', 'js_composer' )
...
vc_map( array(
	...
	'params'      => array(
		...
		array(
			'type'        => 'vc_webuild_exploded_textarea',
			'heading'     => 'Features',
			'param_name'  => 'content',
...
vc_map( array(
	...
	'params'      => array(
		...
		array(
			...
			'param_name'  => 'content',
			'value'       => wp_kses(__( '<p>Toggle content goes here, click edit button to change this text.</p>', 'js_composer' ),$allowed_html),
...
vc_map( array(
	...
	'params'        => array(
		array(
			...
			'param_name'  => 'content',
			'value'       => wp_kses(__( '' . base64_encode( '<script type="text/javascript"> alert("Enter your js here!" ); </script>' ), 'js_composer' ),$allowed_html), // added '' to fix theme check warning
...
vc_map( array(
	...
	'params'      => array(
		...
		array(
			...
			'param_name'  => 'nav_menu',
			'value'       => $custom_menus,
			'description' => empty( $custom_menus ) ? wp_kses(__( 'Custom menus not found. Please visit <b>Appearance > Menus</b> page to create new menu.', 'js_composer' ),$allowed_html) : esc_html__( 'Select menu', 'js_composer' ),
			'admin_label' => true
		),
		array(
			'type'        => 'textfield',
