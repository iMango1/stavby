 ...
 *
 */
function webuild_button( $atts, $content = '', $id = '' ) {
...
add_shortcode( 'webuild_button', 'webuild_button' );
/**
 *
 * PRO Button Group
 * @version 1.0.0
 ...
 *
 */
function webuild_button_group( $atts, $content = '', $id = '' ) {
	extract( shortcode_atts( array(
		'id'    => '',
		'class' => '',
	), $atts ) );
...
add_shortcode( 'webuild_button_group', 'webuild_button_group' );