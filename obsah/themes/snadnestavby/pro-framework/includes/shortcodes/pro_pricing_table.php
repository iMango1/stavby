 ...
 *
 */
function webuild_pricing_table( $atts, $content = '', $id = '' ) {
	...
	$regex = webuild_get_shortcode_regex( 'webuild_pricing_column' );
	// count columns
...
add_shortcode( 'webuild_pricing_table', 'webuild_pricing_table' );
/**
 *
 * PRO Pricing Column
 * @version 1.0.0
 ...
 *
 */
function webuild_pricing_column( $atts, $content = '', $id = '' ) {
	global $webuild_pricing_columns;
	extract( shortcode_atts( array(
		'id'             => '',
		'class'          => '',
...
add_shortcode( 'webuild_pricing_column', 'webuild_pricing_column' );