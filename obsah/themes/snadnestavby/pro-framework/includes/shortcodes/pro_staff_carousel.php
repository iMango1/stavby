...
/*-----------------------------------------------------------------------------------*/
function vc_staff( $atts, $content = null ) {
...
function vc_staff_carousel( $atts, $content = null ) {
	extract( shortcode_atts( array(
		'hover_effect'         => 'no',
		'staff_groups'         => '',
		'posts_per_line'       => '4',
...
add_shortcode( 'vc_staff_carousel', 'vc_staff_carousel' );
add_shortcode( 'vc_staff', 'vc_staff' );
?>
