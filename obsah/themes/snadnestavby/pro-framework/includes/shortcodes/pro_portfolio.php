 ...
 *
 */
function webuild_portfolio( $atts, $content = '', $id = '' ) {
	...
	if ( have_posts() ) :
		...
		if ( ! $no_filter ) {
			...
			echo '<a href="#" data-filter="*" class="active">' . esc_html__( 'All', 'webuild' ) . '</a>';
		...
		while( have_posts() ) : the_post();
			...
			webuild_portfolio_item( $item_args );
		endwhile;
...
add_shortcode( 'webuild_portfolio', 'webuild_portfolio' );
add_shortcode( 'vc_portfolio', 'webuild_portfolio' );