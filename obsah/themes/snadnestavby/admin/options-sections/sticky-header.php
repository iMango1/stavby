...
Redux::setSection( $opt_name, array(
	...
	'fields' => array(
		array(
			...
			'subtitle' => esc_html__( 'By using these options, your website’s header will be affected. You can enable/disable a sticky header both on desktops and on mobile devices and set it’s padding, font size, height and background color', 'webuild' ),
			'indent'   => true
		),
		array(
			'id'       => 'sticky-header',
